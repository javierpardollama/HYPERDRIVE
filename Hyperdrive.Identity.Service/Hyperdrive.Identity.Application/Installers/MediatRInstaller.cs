using Hyperdrive.Identity.Application.Handlers.ApplicationRole;
using Hyperdrive.Identity.Application.Handlers.ApplicationUser;
using Hyperdrive.Identity.Application.Handlers.Auth;
using Hyperdrive.Identity.Application.Handlers.Security;
using Microsoft.Extensions.DependencyInjection;

namespace Hyperdrive.Identity.Application.Installers;
