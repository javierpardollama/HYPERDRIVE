...
2. Asegúrate de seguir el estilo de código y las directrices de prueba del proyecto.
3. Que todos los casos de prueba existentes se aprueben correctamente.
4. Que se añadan nuevos casos de prueba para dar soporte a la nueva funcionalidad o se modifiquen los existentes según corresponda.
5. Que sigas los comentarios y consejos de los propietarios del código durante la revisión del proceso de PR. 6. Adaptar adecuadamente la documentación en el archivo README correspondiente si es necesario y añadir las notas de la versión correspondientes en el archivo de registro de cambios correspondiente.

### Revisar código
Si tienes experiencia con el proyecto o las tecnologías involucradas, puedes ayudarnos a mejorar la calidad de nuestro código revisando las solicitudes de incorporación de cambios de otros usuarios. Puedes proporcionarnos comentarios sobre el estilo del código, la lógica, la funcionalidad, la documentación, las pruebas o cualquier otro aspecto que consideres relevante. Por favor, sé constructivo y respetuoso en tus comentarios.
