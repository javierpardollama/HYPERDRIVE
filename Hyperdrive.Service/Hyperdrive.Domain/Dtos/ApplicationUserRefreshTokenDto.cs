...
/// <summary>
/// Represents a <see cref="ApplicationUserRefreshTokenDto"/> class. Implements <see cref="IKeyDto"/>, <see cref="IBaseDto"/>
/// </summary>
public class ApplicationUserRefreshTokenDto : IKeyDto, IBaseDto
{
    /// <summary>
