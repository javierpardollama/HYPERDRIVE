...
export class ApplicationUserService extends BaseService {
    ...
    public UpdateApplicationUser(viewModel: UpdateApplicationUser): Promise<ViewApplicationUser> {
        return firstValueFrom(this.httpClient.put<ViewApplicationUser>(`${environment.Api.Service}api/v1/applicationuser/updateapplicationuser`, viewModel)
    ...
    public FindAllApplicationUser(): Promise<ViewCatalog[]> {
        return firstValueFrom(this.httpClient.get<ViewCatalog[]>(`${environment.Api.Service}api/v1/applicationuser/findallapplicationuser`)
    ...
    public FindPaginatedApplicationUser(viewModel: FilterPageApplicationUser): Promise<ViewPage<ViewApplicationUser>> {
        return firstValueFrom(this.httpClient.post<ViewPage<ViewApplicationUser>>(`${environment.Api.Service}api/v1/applicationuser/findpaginatedapplicationuser`, viewModel)
    ...
    public RemoveApplicationUserById(id: number): Promise<any> {
        return firstValueFrom(this.httpClient.delete<any>(`${environment.Api.Service}api/v1/applicationuser/removeapplicationuserbyid/${id}`)
