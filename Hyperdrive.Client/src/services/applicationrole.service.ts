...
export class ApplicationRoleService extends BaseService {
    ...
    public UpdateApplicationRole(viewModel: UpdateApplicationRole): Promise<ViewApplicationRole> {
        return firstValueFrom(this.httpClient.put<ViewApplicationRole>(`${environment.Api.Service}api/v1/applicationrole/updateapplicationrole`, viewModel)
    ...
    public FindAllApplicationRole(): Promise<ViewCatalog[]> {
        return firstValueFrom(this.httpClient.get<ViewCatalog[]>(`${environment.Api.Service}api/v1/applicationrole/findallapplicationrole`)
    ...
    public FindPaginatedApplicationRole(viewModel: FilterPageApplicationRole): Promise<ViewPage<ViewApplicationRole>> {
        return firstValueFrom(this.httpClient.post<ViewPage<ViewApplicationRole>>(`${environment.Api.Service}api/v1/applicationrole/findpaginatedapplicationrole`, viewModel)
    ...
    public AddApplicationRole(viewModel: AddApplicationRole): Promise<ViewApplicationRole> {
        return firstValueFrom(this.httpClient.post<ViewApplicationRole>(`${environment.Api.Service}api/v1/applicationrole/addapplicationrole`, viewModel)
    ...
    public RemoveApplicationRoleById(id: number): Promise<any> {
        return firstValueFrom(this.httpClient.delete<any>(`${environment.Api.Service}api/v1/applicationrole/removeapplicationrolebyid/${id}`)
