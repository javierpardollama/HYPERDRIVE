...
using Hyperdrive.Intelligence.Infrastructure.Helpers;
                          ...
                          ILogger<ChunkManager> logger) : BaseManager(context), IChunkManager
{
                                ...
                                string @filecontent)
    {
        ...
        if (@entities.Count > 0)
        {
            ...
            // Log
            string @logData = $"{nameof(Document)} {@documentid} added its {@entities.Count} {nameof(Chunk)}s at {DateTime.UtcNow:t}";
