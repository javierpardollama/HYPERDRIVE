...
/// <summary>
/// Represents a <see cref="DriveItemBinaryController"/> class. Inherits <see cref="ControllerBase"/>
/// </summary>   
/// <param name="mediator">Injected <see cref="IMediator"/></param>
[ApiVersion(1.0)]
[ApiExplorerSettings(GroupName = "v1")]
[Route("api/v{v:apiVersion}/driveitem/binary")]
[Produces("application/json")]
[Authorize]
[ApiController]
[EnableRateLimiting("Concurrency")]
public class DriveItemBinaryController(IMediator @mediator) : ControllerBase
{
    /// <summary>
    /// Finds Drive Item Binary By DriveItem Version Id
    /// </summary>
